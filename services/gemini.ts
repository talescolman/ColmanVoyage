...
export const getSmartSuggestions = async (criteria: SearchCriteria): Promise<Destination[]> => {
  const prompt = `
    ...
    Using your knowledge and internal capabilities (simulating real-time search), provide current typical weather (TEMPERATURE MUST BE IN CELSIUS) and estimated flight+hotel pricing for this month.
